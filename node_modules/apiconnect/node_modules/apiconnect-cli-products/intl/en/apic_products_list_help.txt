Usage: apic {{products}} [CATALOG_OPTIONS | SPACE_OPTIONS]
  ...
  List the products in the {{production}} catalog
    ...
    {{climbon}}:1.0.0 in {{climbonorg:production}} [status: published]
    {{climbon}}:1.0.1 in {{climbonorg:production}} [status: published]
    {{yosar}}:2.0.0 in {{climbonorg:production}} [status: published]

  List the products in all catalogs of all organizations
    {{$ apic products --all-catalogs --all-organizations --server mgmnthost.com}}
    {{climbon}}:1.0.0 in {{climbonorg:staging}} [status: published]
    {{climbon}}:1.0.0 in {{climbonorg:production}} [status: published]
    {{climbon}}:1.0.1 in {{climbonorg:sandbox}} [status: published]
    {{climbon}}:1.0.1 in {{climbonorg:qa}} [status: published]
    {{climbon}}:1.0.1 in {{climbonorg:production}} [status: published]
    {{yosar}}:2.0.0 in {{climbonorg:production}} [status: published]
    {{trails}}:1.0.0 in {{hikingorg:staging}} [status: published]
    {{trails}}:2.0.0 in {{hikingorg:production}} [status: published]
  ...
  List the products in the {{flights}} space
    ...
    {{climbon}}:1.0.0 in {{climbonorg:production:flights}} [status: published]
    {{climbon}}:1.0.1 in {{climbonorg:production:flights}} [status: published]
    {{yosar}}:2.0.0 in {{climbonorg:production:flights}} [status: published]
