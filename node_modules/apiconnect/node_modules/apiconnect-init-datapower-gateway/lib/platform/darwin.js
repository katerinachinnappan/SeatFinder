...
const DOCKER_PLATFORM = 'Docker for Mac';
const UNINSTALL_TOOLBOX_URL = 'https://docs.docker.com/toolbox/toolbox_install_mac/#how-to-uninstall-toolbox';
const INSTALL_URL = 'https://docs.docker.com/docker-for-mac/install/';
...
const ERRORS = {
  ...
  'BAD_VERSION': msg => {
    ...
    return `
      ...
      If you installed Docker or any other components, such as docker-compose or docker-machine, via Homebrew, please
      uninstall them, also via Homebrew. Then, to be safe, please also follow the uninstallation instructions here:
      ${UNINSTALL_TOOLBOX_URL}
...
exports.name = () => `MacOS (release ${os.release()})`;
