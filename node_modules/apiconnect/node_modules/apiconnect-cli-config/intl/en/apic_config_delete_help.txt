Usage: apic {{config:delete}} OPTIONS NAME

  Delete a configuration variable

  Options
    -l, --{{local}}       delete the local application configuration variable ({{loopback}} project only)
    -g, --{{global}}      delete the global configuration variable
