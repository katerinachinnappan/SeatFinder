Usage: apic {{config:get}} NAME

  Get a configuration variable

  Options
    -l, --{{local}}       get the local application configuration variable ({{loopback}} project only)
    -g, --{{global}}      get the global configuration variable
