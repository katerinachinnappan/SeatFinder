Usage: apic {{config:set}} OPTIONS NAME=VALUE ...

  Set or update one or more configuration variables

  Options
    -l, --{{local}}       set the local application configuration variable ({{loopback}} project only)
    -g, --{{global}}      set the global configuration variable
  ...
  Configuration variables:
    ...
    {{app}}
      The app configuration variable should be set to the URI of API
    ...
    {{oauth-client-type}}
      To test OAuth its necessary to set the OAuth client type, this is typically done using
