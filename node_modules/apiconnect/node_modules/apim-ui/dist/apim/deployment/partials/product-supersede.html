...
********************************************************** {COPYRIGHT-END} **/
-->
<h2 class="bx--modal-content__heading" role="banner" aria-label="{{::'product_manage_supersede' | translate}}">
  <div class="bx--form__legend floatLeft">{{::'product_manage_supersede' | translate}}</div>
...
<div class="bx--modal-content webapi" data-ng-switch="currentPage">
  <div data-ng-switch-default>
    <h5 style="margin-bottom: 15px;">{{::'product_manage_supersede_description' | translate}}</h5>
    <ol class="bx--list--ordered">
      <li class="bx--list__item">{{::'product_manage_supersede_action1' | translate}}</li>
      <li class="bx--list__item">{{::'product_manage_supersede_action2' | translate}}</li>
      <li class="bx--list__item">{{::'product_manage_supersede_action3' | translate}}</li>
    </ol>
    <h5 style="margin-bottom: 15px;">{{::'product_manage_select_to_supersede' | translate}}</h5>
    ...
    <div class="primaryBorder" style="margin-bottom: 15px;">
      ...
      <ul class="simpleList productVersions cardContainer">
        <li data-ng-repeat="productVersion in filteredProductVersions = (productVersions | deploymentNameOnlyQuery: productVersionQuery | otherPublishedProductVersions: productVersion)" ng-class-even="'bxTableRowEven'" ng-class-odd="'bxTableRowOdd'" ng-class="'productRow'">
      ...
      <div class="mediumPadding no-animate" data-ng-show="filteredProductVersions.length == 0">{{productVersions | deploymentProductReplaceNoDescriptors}}</div>
    </div>
  </div>
  <div data-ng-switch-when="2">
    <h5 style="margin-bottom: 15px;">{{::'product_manage_supersede_plans' | translate}}</h5>
    <div class="tableHeaderBackground" style="padding-left: 10px;">
      <div class="column halfColumn">
        <div>{{::'product_manage_supersede_action' | translate}}</div>
      ...
      <ul class="simpleList">
        <li class="secondaryBorder borderBottom" style="padding: 10px;" data-ng-repeat="plan in selectedProductVersion.dependents.PLANVERSION">
          <div class="bx--select labeledSelect">
            ...
            <select class="productPlanSelector bx--select__input" required data-ng-model="planTargets[plan.planName]" title="{{::'productSupersedeSelectTarget' | translate}}">
...
<div class="bx--modal__buttons" role="contentinfo" aria-label="{{::'footerSectionLabel' | translate}}">
  ...
  <div class="bx--modal__buttons-container">
    ...
    <button class="bx--btn no-animate" type="button" data-ng-show="currentPage == 2" data-ng-disabled="!productMappings.$valid" data-ng-click="supersedeVersion(selectedProductVersion)">
      {{::'product_manage_supersede_action' | translate}}
    </button>
  </div>
</div>
