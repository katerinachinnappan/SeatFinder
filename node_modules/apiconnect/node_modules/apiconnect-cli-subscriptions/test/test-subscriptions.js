...
test('subscriptions', function(t) {
  ...
  logger.clear();
  return apic(f('subscriptions -c %s -o %s -s %s', testCatalog, testOrg, conf.getServer()))
    .then(function() {
...
test('subscriptions:list', function(t) {
  startMockServer(conf.getServer(), testOrg, testCatalog);
  logger.clear();
  return apic(f('subscriptions:list -c %s -o %s -s %s', testCatalog, testOrg, conf.getServer()))
    .then(function() {
      var output = logger.values();
      t.equals(output.length, 1);
      t.equals(output[0],
...
test('subscriptions:list using product', function(t) {
  ...
  logger.clear();
  return apic(f('subscriptions:list -p %s -c %s -o %s -s %s', product, testCatalog, testOrg, conf.getServer()))
    .then(function() {
      var output = logger.values();
      t.equals(output.length, 1);
      t.equals(output[0],
...
test('subscriptions:list using product & version', function(t) {
  ...
  logger.clear();
  return apic(f('subscriptions:list -p %s -c %s -o %s -s %s', prodVersion, testCatalog, testOrg, conf.getServer()))
    .then(function() {
      var output = logger.values();
      t.equals(output.length, 1);
      t.equals(output[0],
...
test('subscriptions:list using product & version & plan', function(t) {
  ...
  logger.clear();
  return apic(f('subscriptions:list -p %s -c %s -o %s -s %s', prodVersionPlan, testCatalog, testOrg, conf.getServer()))
    .then(function() {
      var output = logger.values();
      t.equals(output.length, 1);
      t.equals(output[0],
...
test('negative: subscriptions:list [no catalog]', function(t) {
  startMockServer(conf.getServer(), testOrg, testCatalog);
  logger.clear();
  return apic(f('subscriptions:list -o %s -s %s', testOrg, conf.getServer()))
    .then(t.fail)
    .catch(function(err) {
      t.ok(err);
...
test('negative: subscriptions:list [no org]', function(t) {
  startMockServer(conf.getServer(), testOrg, testCatalog);
  logger.clear();
  return apic(f('subscriptions:list -c %s -s %s', testCatalog, conf.getServer()))
    .then(t.fail)
    .catch(function(err) {
      t.ok(err);
...
test('negative: subscriptions:list [no server]', function(t) {
  startMockServer(conf.getServer(), testOrg, testCatalog);
  logger.clear();
  return apic(f('subscriptions:list -c %s -o %s', testCatalog, testOrg))
    .then(t.fail)
    .catch(function(err) {
      t.ok(err);
...
test('subscriptions:get', function(t) {
  ...
  logger.clear();
  return apic(f('subscriptions:get %s -c %s -o %s -s %s', subscriptionName, testCatalog, testOrg, conf.getServer()))
    .then(function() {
      var output = logger.values();
...
test('negative: subscriptions:get [no catalog]', function(t) {
  startMockServer(conf.getServer(), testOrg, testCatalog, null, subscriptionName);
  logger.clear();
  return apic(f('subscriptions:get %s -o %s -s %s', subscriptionName, testOrg, conf.getServer()))
    .then(t.fail)
    .catch(function(err) {
      t.ok(err);
      t.equals(err.message, 'The --catalog option is required.');
...
test('negative: subscriptions:get [no org]', function(t) {
  startMockServer(conf.getServer(), testOrg, testCatalog, null, subscriptionName);
  logger.clear();
  return apic(f('subscriptions:get %s -c %s -s %s', subscriptionName, testCatalog, conf.getServer()))
    .then(t.fail)
    .catch(function(err) {
      t.ok(err);
      t.equals(err.message, 'The --organization option is required.');
...
test('negative: subscriptions:get [no server]', function(t) {
  startMockServer(conf.getServer(), testOrg, testCatalog, null, subscriptionName);
  logger.clear();
  return apic(f('subscriptions:get %s -c %s -o %s', subscriptionName, testCatalog, testOrg))
    .then(t.fail)
    .catch(function(err) {
      t.ok(err);
      t.equals(err.message, 'The --server option is required.');
