...
*/
function getOpenApiV3(swagger, createOptions) {
    ...
    swagger2openapi.convertObj(swagger, s2oaOptions). then(function(s2oaOptions) {
        try {
            let swagger = s2oaOptions.openapi;
            ...
            if (swagger['x-ibm-configuration'].targets) {
                ...
                Promise.all(promises).then(values => {
                    ...
                    swagger = postgen.c14nxso(swagger, req);
                    def.resolve(swagger);
                }).catch(reason => {
                    def.reject(reason);
                });
